  ...
  return (
    <section className="relative pt-20 pb-12 md:pt-24 md:pb-16 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-12 gap-8 md:gap-12 items-start">
        ...
        >
          {/* Eyebrow */}
          <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand/10 border border-brand/20 text-brand text-xs font-semibold tracking-wide uppercase">
          ...
          <motion.p variants={itemVariants} className="text-base md:text-lg text-light-muted dark:text-dark-muted leading-relaxed max-w-2xl">
          ...
          <motion.div variants={itemVariants} className="flex flex-wrap gap-x-5 gap-y-2 text-sm text-light-muted dark:text-dark-muted font-medium pt-1">
          ...
          <motion.div variants={itemVariants} className="pt-2 flex flex-wrap items-center gap-3">
            <motion.div whileHover={{ scale: 1.03, y: -2 }} whileTap={{ scale: 0.97 }}>
              <Link
                to="/projects"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-brand text-white font-medium text-sm shadow-md hover:bg-brand-600 hover:shadow-lg transition-all duration-200"
              >
            ...
            <motion.div whileHover={{ scale: 1.03, y: -2 }} whileTap={{ scale: 0.97 }}>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-brand/10 border border-brand/30 text-brand font-medium text-sm hover:bg-brand hover:text-white transition-all duration-200"
              >
        ...
        <motion.div
          ...
          className="md:col-span-5 flex justify-center md:justify-end pt-2 md:pt-0"
        >
          <div className="relative group">
            ...
            <motion.div
              ...
              className="absolute -bottom-3 -left-4 px-3.5 py-1.5 rounded-xl bg-light-bg/95 dark:bg-dark-bg/95 backdrop-blur border border-light-border dark:border-dark-border shadow-lg"
            >
