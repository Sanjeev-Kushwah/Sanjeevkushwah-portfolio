        ...
        <div className="space-y-4">
          ...
          {certifications.map((c) => (
            ...
            >
              <div className="flex items-center justify-between gap-2">
                ...
                {c.link && (
                  <a
                    ...
                    className="p-1.5 rounded-lg text-light-muted dark:text-dark-muted hover:text-brand hover:bg-brand/10 transition-colors"
                  >
              ...
              <p className="mt-2 text-xs text-light-muted dark:text-dark-muted leading-relaxed">{c.detail}</p>
            </div>
          ))}
        </div>
      </div>
